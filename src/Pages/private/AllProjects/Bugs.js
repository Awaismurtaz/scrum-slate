...
import Buges from "../../../assets/images/AllTasks/Bug.png";
      ...
      <Box className="overview_section backlog-section">
        <div role="presentation" className="breadcrumbs">
          <Breadcrumbs>
            ...
            <Link to="/allbuges" className="link text-primary">
                Bugs
            </Link>
          </Breadcrumbs>
        </div>
        ...
        <Box className="alltasks overview">
            <Box className="alltasks">
              {[...Array(10)].map((i, x) => (
                <Box>
                  <Paper className="taskslist" elevation={3} sx={{borderRadius:"10px"}}>
                    <Bugslist key={i}/>
                  </Paper>
                </Box>
              ))}
